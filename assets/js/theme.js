...
// Determine the expected state of the theme toggle. Default is light.
...
// The selected setting is the computed theme because there is no system mode.
...
let initTheme = () => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    // The upstream header includes an icon for its system mode; remove it since
    // this site offers only explicit light and dark choices.
    const systemToggle = document.getElementById("light-toggle-system");
